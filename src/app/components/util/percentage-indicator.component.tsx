...
let isPositive:boolean = (props?.amount ?? 0) >= 0.0;

return (<>
       
       {props.amount!= undefined ? (isPositive ? <span className="text-success ps-1"><img src="/arrowUp.png" width="15" height="15"/>{normalizedAmount}%</span>
